...
from XpenseMeter.models import Expense
from XpenseMeter.database import get_db
from fastapi import Depends, Request
from sqlalchemy.orm import Session
from XpenseMeter.services.common_functions import get_current_user, verify_category, verify_monthly_limit, get_expenses
from XpenseMeter.services.email_service import EmailSender
